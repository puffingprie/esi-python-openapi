...
class TestWarsWarIdGet(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> WarsWarIdGet:
        ...
        if include_optional:
            return WarsWarIdGet(
                aggressor = eve_esi_python.models.wars_war_id_get_aggressor.WarsWarIdGet_aggressor(
                    alliance_id = 56, 
                    corporation_id = 56, 
                    isk_destroyed = 1.337, 
                    ships_killed = 56, ),
                allies = [
                    eve_esi_python.models.wars_war_id_get_allies_inner.WarsWarIdGet_allies_inner(
                        alliance_id = 56, 
                        corporation_id = 56, )
                    ],
                declared = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                defender = eve_esi_python.models.wars_war_id_get_defender.WarsWarIdGet_defender(
                    alliance_id = 56, 
                    corporation_id = 56, 
                    isk_destroyed = 1.337, 
                    ships_killed = 56, ),
